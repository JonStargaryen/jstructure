...
//            try {
//                Path pdbFile = Files.createTempFile(null, null);
//                Files.write(pdbFile, protein.composePDBRecord().getBytes());
//                EnergyProfileCalculatorRunner.main(pdbFile.toFile().getAbsolutePath());
