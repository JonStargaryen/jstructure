 ...
 */
public class T01_DownloadPdbtmAlphaNrDataset {
    private static final Logger logger = LoggerFactory.getLogger(T01_DownloadPdbtmAlphaNrDataset.class);
    ...
    public static void main(String[] args) {
        String selectedIds = MembraneConstants.lines(FETCH_URL)
                .filter(T01_DownloadPdbtmAlphaNrDataset::handlePdbId)
                .collect(Collectors.joining(System.lineSeparator()));
        MembraneConstants.write(MembraneConstants.PDBTM_ALPHA_DATASET_DIRECTORY.resolve("pdbtm_alpha_nr.list"), selectedIds);
    }
    ...
    private static boolean handlePdbId(String chainId) {
        try {
            ...
            MembraneConstants.write(MembraneConstants.PDBTM_ALPHA_DATASET_PDB_DIRECTORY.resolve(pdbId + ".pdb"),
