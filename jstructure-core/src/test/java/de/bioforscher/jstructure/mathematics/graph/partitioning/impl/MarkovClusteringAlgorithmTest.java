package de.bioforscher.jstructure.mathematics.graph.partitioning.impl;
...
public class MarkovClusteringAlgorithmTest {
    private MarkovClusteringAlgorithm markovClusteringAlgorithm;
    ...
    @Before
    public void setup() {
        markovClusteringAlgorithm = new MarkovClusteringAlgorithm();
    ...
    public void shouldReportIdentity() {
        Assert.assertTrue(markovClusteringAlgorithm.numberEqual(1, 1, 4));
        Assert.assertTrue(markovClusteringAlgorithm.numberEqual(0.999999, 1, 4));
        Assert.assertTrue(markovClusteringAlgorithm.numberEqual(0.99999, 1, 4));
    }

    @Test
    public void shouldReportNonIdentity() {
        Assert.assertFalse(markovClusteringAlgorithm.numberEqual(1, 2, 4));
        Assert.assertFalse(markovClusteringAlgorithm.numberEqual(1, 1.001, 4));
        Assert.assertFalse(markovClusteringAlgorithm.numberEqual(0.99, 1, 4));
        Assert.assertFalse(markovClusteringAlgorithm.numberEqual(0.999, 1, 4));
    }

    @Test
    public void shouldRunMCL() {
        MarkovClusteringAlgorithm markovClusteringAlgorithm = new MarkovClusteringAlgorithm(MarkovClusteringAlgorithm.DEFAULT_EXPAND_FACTOR,
                1.5,
                MarkovClusteringAlgorithm.DEFAULT_MULT_FACTOR,
                MarkovClusteringAlgorithm.DEFAULT_MAX_ITERATIONS,
                Edge::getWeight);

        PartitionedGraph<String> clustering = markovClusteringAlgorithm.partitionGraph(graph);
