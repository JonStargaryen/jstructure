 ...
 */
public class ProteinIdentifier extends AbstractIdentifier {
    private final String pdbId;
    private final String additionalName;
    public static final ProteinIdentifier UNKNOWN_PROTEIN_IDENTIFIER = IdentifierFactory.createProteinIdentifier("1xxx", "UNKNOWN-PROTEIN");
    ...
    public boolean equals(Object other) {
        ...
        ProteinIdentifier pdbId1 = (ProteinIdentifier) other;
