...
public class KinkFinderHelix {
    ...
    public KinkFinderHelix(String pdbCode, int helixStart, int helixEnd, int kinkPosition, int kinkStart, int kinkEnd,
                           double kinkAngle, String sequence, double nRadius, double nRmsd, double cRadius, double cRmsd,
