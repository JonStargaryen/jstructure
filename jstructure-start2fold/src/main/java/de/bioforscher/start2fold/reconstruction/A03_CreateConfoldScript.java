...
public class A03_CreateConfoldScript {
    private static final Path DIRECTORY = Start2FoldConstants.START2FOLD_DIRECTORY;
...
//                        .collect(Collectors.joining(System.lineSeparator())));
        Start2FoldConstants.write(DIRECTORY.resolve("conventional-late_sampled-reconstruction.sh"),
                Start2FoldConstants.lines(DIRECTORY.resolve("ids.list"))
                        .map(A03_CreateConfoldScript::handlePdbIdForConventionalLateSampled)
                        .collect(Collectors.joining(System.lineSeparator())));
        Start2FoldConstants.write(DIRECTORY.resolve("conventional-late_selected-reconstruction.sh"),
                Start2FoldConstants.lines(DIRECTORY.resolve("ids.list"))
